...
let items = [
    {name: 'Acrylic Full Set', category: 'Crown Nails', price: 46},
    {name: 'Acrylic Fill', category: 'Crown Nails', price: 41},
    {name: 'Gel Full Set', category: 'Crown Nails', price: 60},
    {name: 'Gel Fill', category: 'Crown Nails', price: 55},
    {name: 'Dip Powder Full Set', category: 'Crown Nails', price: 40},
    {name: 'Dip Powder Full Set', category: 'Crown Nails', price: 45, description: 'With extension nails'},
    {name: 'Acrylic Ombre Full Set', category: 'Crown Nails', price: 65},
    {name: 'Acrylic Ombre Fill', category: 'Crown Nails', price: 60},
    {name: 'Gel Removal', category: 'Crown Nails', price: 15},
    {name: 'Long Nails Extension (> 28mm) Extra', category: 'Crown Nails', price: 5},
    {name: 'Long Nails Extension (> 35mm) Extra', category: 'Crown Nails', price: 10},
    {name: 'Regular Manicure', category: 'Manicure', price: 18},
    {name: 'Shellac Manicure', category: 'Manicure', price: 28},
    {name: 'Shellac Polish', category: 'Manicure', price: 22, description: 'With Nails Cut and File'},
    {name: 'Regular Polish', category: 'Manicure', price: 12, description: 'With Nails Cut and File'},
    {name: 'Shellac Remove', category: 'Manicure', price: 10},
    {name: 'Finger Nails Cut', category: 'Manicure', price: 10},
    {name: 'Nail Art (2 Nails)', category: 'Manicure', price: '5+'},
    {name: 'Regular Pedicure', category: 'Pedicure', price: 26},
    {name: 'Crown Pedicure', category: 'Pedicure', price: 60, description: 'Scrub + Mineral Mask + Hot Stones + Paraffin $15'},
    {name: 'Deluxe Pedicure', category: 'Pedicure', price: 45, description: 'Scrub $6 + Mineral Mask $8 + Hot Stones $5'},
    {name: 'Shellac Pedicure', category: 'Pedicure', price: 36},
    {name: 'Toe Care', category: 'Pedicure', price: 20},
    {name: 'Regular Polish', category: 'Pedicure', price: 15, description: 'With Nails Cut and File'},
    {name: 'Shellac Polish', category: 'Pedicure', price: 25, description: 'With Nails Cut and File'},
    {name: 'Shellac Removal', category: 'Pedicure', price: 10},
    {name: 'Toe Nails Cut', category: 'Pedicure', price: 10},
